            ...
            if self.use_ssh:
                ...
                for file_info in all_files_info:
                    ...
                    if filename.endswith('_metadata.json'):
                        ...
                        if self.process_all or file_key not in self.processed_files:
                            ...
                            logger.debug(f"   Найден {'новый' if file_key not in self.processed_files else 'повторный'} файл метаданных: {filename}")
                        else:
                ...
                for file_path in self.container_dir.glob("*_metadata.json"):
                    ...
                    if self.process_all or file_str not in self.processed_files:
                        ...
                        logger.debug(f"   Найден {'новый' if file_str not in self.processed_files else 'повторный'} файл метаданных: {file_path.name}")
                    else:
